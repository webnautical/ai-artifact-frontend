...
export default function DashboardDefault() {
  ...
  const getArtistInfo = async () => {
    ...
    try {
      const api = role === "artist" ? "artist/ArtistDashboard" : role === "affiliate" ? "affiliate/AffiliateDashboard" : "admin/AdminDashboard"
          ...
          <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            <>
...

              {
                ...
                <>
                  <Grid item xs={6} sm={4} md={3} lg={2}>
                    <AnalyticEcommerce title="Total Artists" count={dashboardInfo?.totalArtists || 0} percentage={59.3} extra="35,000" />
                  </Grid>
                  <Grid item xs={6} sm={4} md={3} lg={2}>
                    <AnalyticEcommerce title="Total Affiliates" count={dashboardInfo?.totalAffiliates || 0} percentage={70.5} extra="8,900" />
                  </Grid>
                  <Grid item xs={6} sm={4} md={3} lg={2}>
                    <AnalyticEcommerce title="Total Customers" count={dashboardInfo?.totalCustomers || 0} percentage={27.4} isLoss color="warning" extra="1,943" />
                  </Grid>
                </>
              }
