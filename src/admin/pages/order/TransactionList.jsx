                                ...
                                <Row className="art_details_box">
                                    <Col md={12}>
                                        <div>
                                            ...
                                            <p> <strong>Transaction ID:</strong> {selectedRow.transactionId} </p>
                                            ...
                                            <div>
                                                <hr /><strong>Payment Intent Details:</strong><hr />

                                                <ul>
                                                    {Object.entries(selectedRow?.paymentResponse).map(([key, value]) => (
                                                        <li key={key}>
                                                            <strong>{key}: </strong>
                                                            {Array.isArray(value) ? (
                                                                <ul>
