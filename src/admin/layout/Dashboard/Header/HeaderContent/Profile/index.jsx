                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      <Grid item>
                        <Stack direction="row" spacing={1.25} alignItems="center">
                          ...
                          <Stack>
                            <Typography variant="h6">{auth('admin')?.name}</Typography>
                            <Typography variant="body2" color="text.secondary" className='text-capitalize'>{auth('admin')?.user_role}</Typography>
                          </Stack>
                        </Stack>
                      </Grid>
                    </Grid>
