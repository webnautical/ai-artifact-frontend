...
const ProductDetail = () => {
  const { getGeneralSettingFun, generalSetting, addToCartFun, contextLoader, cartList, getGelatoPriceArrayFun, gelatoPriceArr, addRemoveWishList } = useFrontDataContext();
